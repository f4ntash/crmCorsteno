...
export function ExperienceDetailPage({
  ...
  const publicUrl = publicExperienceUrl(experience.slug);
  return <main className="page experience-workspace">
    <header className="experience-workspace-header">
      ...
      <div className="workspace-actions"><ExperienceQrModal slug={experience.slug} />{canManageCommercial && <button type="button" className="secondary" onClick={() => void clone()}>Duplicar</button>}</div>
    </header>
