...
function fixture(initialDraft = '{"segments":[]}', initialStatus = 'draft', initialPublished: string | null = null, role = 'owner', initialAccessPeriods: AccessPeriod[] = [], platformRole = 'corsteno_admin', initialInventory: InventoryItem[] = [], startsAt: string | null = null, endsAt: string | null = null) {
  const experiences: E[] = [
    { id: 'a', organization_id: 'org-a', name: 'A', slug: 'a', type: 'roulette', status: initialStatus, schema_version: 1, draft_config: initialDraft, published_config: initialPublished, starts_at: startsAt, ends_at: endsAt, created_at: '2026-01-01', updated_at: '2026-01-01' },
