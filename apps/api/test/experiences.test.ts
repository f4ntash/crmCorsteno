...
function fixture(initialDraft = '{"segments":[]}', initialStatus = 'draft', initialPublished: string | null = null, role = 'owner', initialAccessPeriods: AccessPeriod[] = [], platformRole = 'corsteno_admin', initialInventory: InventoryItem[] = [], startsAt: string | null = null, endsAt: string | null = null, initialType = 'roulette') {
  const experiences: E[] = [
  ...
  return { DB: db, EXPERIENCE_ASSETS: assets, ENVIRONMENT: 'test', APP_VERSION: 'test', __spins: spins, __claims: claims, __inventoryEvents: inventoryEvents };
}
