...
CREATE INDEX leads_org_updated ON leads (organization_id, updated_at DESC, id);
CREATE INDEX leads_org_status ON leads (organization_id, status, updated_at DESC);
CREATE INDEX leads_org_category ON leads (organization_id, category, city);
CREATE INDEX leads_org_domain ON leads (organization_id, domain);
...
CREATE INDEX lead_jobs_org_created ON lead_jobs (organization_id, created_at DESC);
