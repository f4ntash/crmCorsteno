...
export type CatalogPublicProduct = { name: string; description: string; priceMinorUnits: number; currency: string; stock: number; mainImageUrl: string | null; ctaLabel: string | null; ctaUrl: string | null };
