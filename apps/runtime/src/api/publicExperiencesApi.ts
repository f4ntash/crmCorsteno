...
export type PublicExperienceResponse = { active: boolean; reason?: string; experience?: { id: string; type: string; config: Roulette3DConfig; startsAt: string | null; endsAt: string | null; featureEntitlements: CommercialEntitlements; prizeAvailability?: Record<string, 'available' | 'sold_out'>; recovery?: SpinResult } };
